 ...
 */
package br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento;
...
public class RecepcaoEventoStub extends org.apache.axis2.client.Stub {
     ...
     * @see br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEvento#nfeRecepcaoEvento
     * @param nfeDadosMsg0
    
     * @param nfeCabecMsg1
    
     */
    public br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeRecepcaoEventoResult nfeRecepcaoEvento(
            br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeDadosMsg nfeDadosMsg0, br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeCabecMsg7 nfeCabecMsg1)
        ...
        try {
            ...
            java.lang.Object object = fromOM(
                    ...
                    br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeRecepcaoEventoResult.class,
                    getEnvelopeNamespaces(_returnEnv));
            _messageContext.getTransportOut().getSender().cleanup(_messageContext);

            return (br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeRecepcaoEventoResult) object;
     ...
     * @see br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEvento#startnfeRecepcaoEvento
     * @param nfeDadosMsg0
    ...
    public void startnfeRecepcaoEvento(
            br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeDadosMsg nfeDadosMsg0, br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeCabecMsg7 nfeCabecMsg1,
            final br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoCallbackHandler callback)
            throws java.rmi.RemoteException {
            ...
            public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    callback.receiveResultnfeRecepcaoEvento(
                            (br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeRecepcaoEventoResult) object);
    ...
    public static class ExtensionMapper {
        ...
        public static java.lang.Object getTypeObject(java.lang.String namespaceURI,
            ...
            if ("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento".equals(namespaceURI)
    ...
    private org.apache.axiom.om.OMElement toOM(br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeDadosMsg param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {


        try {
            return param.getOMElement(br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeDadosMsg.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
    ...
    private org.apache.axiom.om.OMElement toOM(br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeRecepcaoEventoResult param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {


        try {
            return param.getOMElement(br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeRecepcaoEventoResult.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.om.OMElement toOM(br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeCabecMsg7 param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {


        try {
            return param.getOMElement(br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeCabecMsg7.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeDadosMsg param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {
        ...
        try {
            ...
            emptyEnvelope.getBody().addChild(param.getOMElement(br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(
        ...
        try {
            ...
            if (br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeDadosMsg.class.equals(type)) {

                return br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());


            }

            if (br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeRecepcaoEventoResult.class.equals(type)) {

                return br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeRecepcaoEventoResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());


            }

            if (br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeCabecMsg7.class.equals(type)) {

                return br.com.jcomputacao.cartaCorrecao.ws.recepcaoEvento.RecepcaoEventoStub.NfeCabecMsg7.Factory.parse(param.getXMLStreamReaderWithoutCaching());
